...
BotConfig = {
    ...
    PNG = { animationSpeed = 2, animations = { [BOT_ANIMATION_STATES.Idle] = { 1, 4 }, [BOT_ANIMATION_STATES.Talking] = { 5, 8 }, [BOT_ANIMATION_STATES.Sad] = { 9, 12 }, [BOT_ANIMATION_STATES.Happy] = { 13, 16 } } },
