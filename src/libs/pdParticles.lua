...
---@field type number
---@operator call: Particle
Particle = class("Particle").extends() or Particle
...
---@field type 1
---@operator call: ParticleCircle
ParticleCircle = class("ParticleCircle", { type = 1 }).extends(Particle) or ParticleCircle
...
---@field type 2
---@operator call: ParticlePoly
ParticlePoly = class("ParticlePoly", { type = 2 }).extends(Particle) or ParticlePoly
...
---@field type 3
---@operator call: ParticleImage
ParticleImage = class("ParticleImage", { type = 3 }).extends(Particle) or ParticleImage
...
---@class ParticleImageBasic : ParticleImage
---@field type 3
---@operator call: ParticleImageBasic
ParticleImageBasic = class("ParticleImageBasic", { type = 3 }).extends(ParticleImage) or ParticleImageBasic
...
Particles = class("Particles").extends() or Particles
